...
export default function Connect() {
  const platforms = [
    { name: "LeetCode", icon: <SiLeetcode />, link: "https://leetcode.com/u/DheerajSharma27/" },
    { name: "Twitter", icon: <FaTwitter />, link: "https://x.com/Dheeraj89537774" },
    { name: "Instagram", icon: <FaInstagram />, link: "https://instagram.com/dheerajr_99" },
    { name: "GitHub", icon: <FaWordpress />, link: "https://github.com/dheerajdj5" },
    { name: "Facebook", icon: <FaMedium />, link: "https://facebook.com/dheeraj.r.900" },
  ];
